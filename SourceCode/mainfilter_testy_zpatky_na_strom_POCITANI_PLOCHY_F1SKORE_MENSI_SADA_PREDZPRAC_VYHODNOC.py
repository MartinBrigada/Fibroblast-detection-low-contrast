...
def kresli_obarvene_kontury_gauss(contours, image,gaussian_dict):
    ...
    print(f'Suma platnych bunek v konturach GAUSS: {jedna + dva*2 + tri*3 + ctyri*4}') 
...
# slozka = 'B1_04_1_2_Bright_field' 
slozka = 'B1_04_1_4_Bright_field'
...
# csv_soubor = 'B1_04_2_2_spots.csv'
csv_soubor = 'B1_04_2_4_spots.csv'
...
# print(f'Nejvetsi rozdil v sade byl {top_rodil}')
    ...
    _,metrics = kresli_a_vyhodnot_kontury_GAUSS_POCET(filtered_contours, image, gaussian_dict, data_list,tol=50,draw=False) #toto se pouzivalo
...
# total_tp = sum([0,0])
# total_fp = sum([0,0])
# total_fn = sum([200,200])
# precision = total_tp / (total_tp + total_fp) if total_tp + total_fp > 0 else 0
# recall = total_tp / (total_tp + total_fn) if total_tp + total_fn > 0 else 0
# f1_score = (2 * precision * recall) / (precision + recall) if precision + recall > 0 else 0    
# print(f"Precision pro sadu mensich poctu: {precision:.2f}")
# print(f"Recall pro sadu mensich poctu: {recall:.2f}")
# print(f"F1 Score pro sadu mensich poctu: {f1_score:.2f}")    
...
# =============================================================================
# # vysl mensi sada 400 obr max 3 bunky v konture toto plati BEZ ICA
# total_tp = sum([170,189])
# total_fp = sum([0,9])
# total_fn = sum([30,2])
# # Celkové Precision: 0.98
# # Celkové Recall: 0.92
# # Celkové F1 Score: 0.95
# =============================================================================

# =============================================================================
# # vysl mensi sada 400 obr max 3 bunky v konture toto plati BEZ ICA, CLAHE
# total_tp = sum([0,0])
# total_fp = sum([0,0])
# total_fn = sum([200,200])
# # Celkové Precision: 0
...
# =============================================================================
# # vysl mensi sada 400 obr max 3 bunky v konture toto plati BEZ ICA, HISTOGRAM EQUALISATION
# total_tp = sum([0,0])
# total_fp = sum([0,0])
# total_fn = sum([200,200])
# # Celkové Precision: 0
...
# =============================================================================
# # vysl mensi sada 400 obr max 3 bunky v konture toto plati BEZ ICA, WIENER
# total_tp = sum([0,0])
# total_fp = sum([0,0])
# total_fn = sum([200,200])
# # Celkové Precision: 0
